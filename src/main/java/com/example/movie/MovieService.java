...
public class MovieService implements MovieRepository {
    ...
    public ArrayList<Movie> getMovies() {
        Collection<Movie> employeeCollection = movieList.values();
        ArrayList<Movie> movies = new ArrayList<>(employeeCollection);
        return movies;
    }
    ...
    public Movie updateMovie(int movieId, Movie movie) {
        ...
        if (existingMovie.getMovieName() != null) {
            existingMovie.setMovieName(movie.getMovieName());
        }
        if (existingMovie.getLeadActor() != null) {
